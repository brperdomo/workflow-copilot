...
import { errorLib, serviceClient } from '@portal/commonLib';
...
export function PowerFormService(
  ...
  function getRuntimeUrl(params) {
    var url = `${Settings.nodeRoot}/tasktypes/${
      params.recipientTaskSid
    }/power-form/runtime/${params.baseTaskSid}?process_sid=${
      params.processSid
